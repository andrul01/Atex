...
<body>
    ...
    <!-- <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./Img/cover1.jpg" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1>Explore, Solve, Evolve</h1>
                </div>
            </div>
            <div class="carousel-item">
                <img src="./Img/cover2.jpg" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1>The Pulse of Innovation</h1>
                </div>
            </div>
            <div class="carousel-item">
                <img src="./Img/cover3.jpg" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1>Solving Problems, Sparking Ideas</h1>
                </div>
            </div>
